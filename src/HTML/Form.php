...
class Form
{
    ...
    public function input(string $key, string $label, string $holder=""): string
    {
    ...
    <div class="form-group">
        ...
        <input type="{$type}" id="field{$key}" class="{$this->getInputClass($key)}" name="{$key}" value="{$value}"  placeholder="{$holder}" required >
